...
charadex.site = {
  title: "Urchifics",
  url: "https://urchifics.github.io/urchifics/",
...
charadex.sheet = {
  ...
  id: "1m9ZAG7BW1Vti1fUKDACfq_BnUQqvipGIlyh5TMA518w",
  ...
  options: {
    ...
    designTypes: ['All', 'Official Design', 'Guest Design', 'MYO Design', 'Void'],
    statuses: ['All', 'Resell', 'Trade', 'Gift', 'Voided'],
    rarity: ['All', 'Common', 'Uncommon', 'Rare', 'Legendary', 'Crossbreed'],
    species: ['All', 'Official', 'Guest Artist', 'MYO', 'Void'],
    itemTypes: ['All', 'Currency', 'MYO Slot', 'Trait', 'Trophy', 'Misc'],
    traitTypes: ['All', 'Uncommon', 'Rare', 'Legendary', 'Crossbreed']
